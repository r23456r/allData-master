...
| 192.168.8.9                      | port | ip             |
|-------------------------------| ---- | -------------- |
| eureka                  | 8610 | 192.168.8.9    |
| service-workflow        | 8814 | 192.168.8.9    |
| data-metadata-service-console    | 8821 | 192.168.8.9    |
| service-data-mapping    | 8823 | 192.168.8.9    |
| data-masterdata-service | 8828 | 192.168.8.9    |
| data-quality-service    | 8826 | 192.168.8.9    |
...
#### 5、三节点启动[16gmaster, 192.168.8.9, 16gdata]
> 1. 单独启动 eureka on `192.168.8.9`
>
> 2. 单独启动config on `16gmaster`
>
> 3. 单独启动gateway on `16gdata`
>
> 4. 启动`192.168.8.9`, sh start192.168.8.9.sh
>
